...
def draw_all(
    ...
    This is Natural Language Processing Web App.
    This App is built using pretrained tranined tranformers which are capable of doing wonders with the Textual data.
    ```python
...
def main():
    ...
    if choice == "--Select--":
        st.write("""
                 This is a Natural Language Processing Bases Web App.                
                 """)
        ...
        st.write("""
                NLP is a sub field of Artificial Inteligence (AI) to understand the context of text just like humans.
                 """)
        st.image('NLP.jpeg')
        ...
        if raw_text !="Enter Text Here":
            ...
            for _ in stqdm(range(50), desc="Please wiat a bit. The model is fetching the results!"):
                sleep(0.1)
            ...
            if sentiment == "NEUTRAL":
                st.write("""# This text has a Neutral Sentiment. """)
